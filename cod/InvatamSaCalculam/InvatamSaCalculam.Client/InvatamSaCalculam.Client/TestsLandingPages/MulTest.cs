...
{
    public partial class MulTest : UserControl
    {
        ...
        private void MulTest_ParentChanged(object sender, EventArgs e)
        {
            if (Parent != null)
            {
                GenerateTest();
        ...
        private void SetRandomNumbers()
        {
            ...
            num10 = random.Next(1, 30);
            num11 = random.Next(1, 30);
            num12 = random.Next(1, 100);
            num13 = random.Next(2, 100);
            do
            {
                num14 = random.Next(1, 100);
                num15 = random.Next(1, 1000);
            } while (num15 % num14 != 0);
        }
        ...
        private void GenerateQuestions()
        {
            ...
            lblQuestion5.Text = "Produsul dintre " + Convert.ToString(num10) + " şi " + Convert.ToString(num11) + " este";
            lblQuestion6Top.Text = "Cosmin are " + Convert.ToString(num12) + " maşinuţe, iar George are de " + Convert.ToString(num13) + " ori mai multe.";
            lblQuestion6Bottom.Text = "Câte maşinuţe are George?";
            lblQuestion7Top.Text = "Factorul 1 al înmulţirii este " + Convert.ToString(num14) + ", iar produsul este " + Convert.ToString(num15) + '.';
            lblQuestion7Bottom.Text = "Care este factorul 2?";
        }
        ...
        private void btnCheckTest_Click(object sender, EventArgs e)
        {
            ...
            if (cup == true)
            {
                ...
                {
                    BusinessStructure.Instance.BDService.AddCup(Operations.Mul.ToString(),
