...
{
    public partial class DivTest : UserControl
    {
        ...
        private void DivTest_ParentChanged(object sender, EventArgs e)
        {
            if (Parent != null)
            {
                GenerateTest();
        ...
        private void SetRandomNumbers()
        {
            ...
            do
            {
                num5 = random.Next(1, 100);
                num6 = random.Next(1, 100);
            } while (num5 % num6 != 0);
            do
            {
                num7 = random.Next(1, 1000);
                num8 = random.Next(1, 100);
                num9 = random.Next(1, 100);
            } while ((num7 % num8 != 0) || ((num7 / num8) % num9 != 0));
            do
            {
                num10 = random.Next(1, 100);
                num11 = random.Next(1, 100);
            } while (num10 % num11 != 0);
            do
            {
                num12 = random.Next(1, 1000);
                num13 = random.Next(2, 100);
            } while (num12 % num13 != 0);
            do
            {
                num14 = random.Next(1, 1000);
                num15 = random.Next(1, 100);
            } while (num14 % num15 != 0);
        }
        ...
        private void GenerateQuestions()
        {
            ...
            lblQuestion5.Text = "Câtul dintre " + Convert.ToString(num10) + " şi " + Convert.ToString(num11) + " este";
            lblQuestion6Top.Text = "Alina are " + Convert.ToString(num12) + " flori, iar Bianca are de " + Convert.ToString(num13) + " ori mai puţine.";
            lblQuestion6Bottom.Text = "Câte flori are Bianca?";
            lblQuestion7Top.Text = "Deîmpărţitul este " + Convert.ToString(num14) + ", iar câtul este " + Convert.ToString(num15) + '.';
            lblQuestion7Bottom.Text = "Care este împărţitorul?";
        }
        ...
        private void btnCheckTest_Click(object sender, EventArgs e)
        {
            ...
            if (cup == true)
            {
                ...
                {
                    BusinessStructure.Instance.BDService.AddCup(Operations.Div.ToString(),
